...
// @ts-ignore
  var peg$startRuleFunctions = { cards: peg$parsecards };
// @ts-ignore
  var peg$startRuleFunction = peg$parsecards;
...
// @ts-ignore
  ...
  var peg$e1 = peg$literalExpectation("Card", false);
...
// @ts-ignore
  ...
  var peg$f0 = function(cards) {// @ts-ignore
 return cards; };// @ts-ignore

  var peg$f1 = function(id, have, winning) {// @ts-ignore
 return new Card(id, have, winning); };// @ts-ignore

  var peg$f2 = function(digits) {// @ts-ignore
...
export type ParseFunction = <Options extends ParseOptions>(
    ...
    StartRule extends "cards" ? cards : cards
    : cards;
